...
ProfileTag.create(user_id: @profile1.user_id, tag_id: @tag1.tag_id)
ProfileTag.create(user_id: @profile1.user_id, tag_id: @tag3.tag_id)
ProfileTag.create(user_id: @profile2.user_id, tag_id: @tag4.tag_id)
ProfileTag.create(user_id: @profile2.user_id, tag_id: @tag5.tag_id)
ProfileTag.create(user_id: @profile3.user_id, tag_id: @tag1.tag_id)
ProfileTag.create(user_id: @profile3.user_id, tag_id: @tag2.tag_id)
ProfileTag.create(user_id: @profile4.user_id, tag_id: @tag1.tag_id)
ProfileTag.create(user_id: @profile5.user_id, tag_id: @tag2.tag_id)
